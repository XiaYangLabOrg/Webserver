          ...
          <div class="tabs tabs-bordered clearfix" id="Info_tabs">
            ...
            <div class="tab-content clearfix" id="myGeneRegulation">
              ...
              <p style="text-align: center;margin-bottom:0px">
                The DEG method used was characteristic direction. Studies of different doses and treatment durations were combined and meta-analyzed. Shown are the top 50 significantly regulated genes.
              </p>
              <table id="datatable_deg_app1" class="table table-striped table-bordered-pharm" cellspacing="0" width="100%">
                <!--<caption style="caption-side:top">The DEG method used was characteristic direction. Studies of different doses and treatment durations were combined and meta-analyzed. Shown are the top 50 significantly regulated genes.
                </caption>-->
                <thead>
                  <tr>
                    <th>Drug</th>
              ...
              <p style="text-align: center;margin-bottom:0px">
                The DEG method used was Limma. Shown are the top 50 significantly regulated genes.
              </p>
            ...
            <div class="tab-content clearfix" id="myPathwayRegulation">
              ...
              <p style="text-align: center;margin-bottom:0px">
                The DEG method used was characteristic direction. Pathway enrichment tool used was Enrichr. Shown are the top 10 KEGG pathways and top 10 GO pathways.
              </p>
              ...
              <p style="text-align: center;margin-bottom:0px">
                ...
                Shown are the top 10 KEGG pathways and top 10 GO pathways for Enrichr and top 20 KEGG pathways for network enrichment.
              </p>
  ...
  $('#myDrugName').on('change', function() { // show species for which that drug has data for
    ...
    function convert2drawDEG(arr) { // Jess added
      $.each(arr, function(key, value) {
        ...
        convert.push(value["Upregulated Genes"]);
        convert.push(value["Downregulated Genes"]);
    ...
    $.ajax({ // Jess added
      type: "GET",
      url: "include/pharmomics/PharmOmicsMetaDEGSubset_Jan2021.json", // Doesn't work with Nov2020 for some reason
      dataType: "json",
      success: function(data) {
    ...
    $.ajax({ // Jess added
      type: "GET",
      url: "include/pharmomics/DoseSegregatedDEGSubset_Jan2021.json",
      dataType: "json",
      beforeSend: function() {

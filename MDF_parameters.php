                  ...
                  <div class="modal-body">
                    <select class="SSEA" name="formChoice2" size="1" id="mapping_file" multiple="multiple">
                      <optgroup class="only_one_mapping" label="Only One Mapping file can be selected">
                        <option value="Data/Pipeline/Resources/mappings/gene2loci.010kb.txt">Chromosomal distance 10Kb</option>
                        <option value="Data/Pipeline/Resources/mappings/gene2loci.020kb.txt">Chromosomal distance 20Kb</option>
                        <option value="Data/Pipeline/Resources/mappings/gene2loci.050kb.txt">Chromosomal distance 50Kb</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/combined_49esnps.txt">GTEx 49 Combined eQTLs</option>
                      ...
                      <optgroup class="multiple_mapping" label="Multiple (up to 10) Mapping file(s) can be selected">
                        ...
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Adipose_Visceral_Omentum.txt">GTEx Adipose Visceral Omentum eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Adrenal_Gland.txt">GTEx Adrenal Gland eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Artery_Aorta.txt">GTEx Artery Aorta eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Artery_Coronary.txt">GTEx Artery Coronary eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Artery_Tibial.txt">GTEx Artery Tibial eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Amygdala.txt">GTEx Brain Amygdala eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Anterior_cingulate_cortex_BA24.txt">GTEx Brain Anterior cingulate cortex BA24 eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Caudate_basal_ganglia.txt">GTEx Brain Caudate basal ganglia eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Cerebellar_Hemisphere.txt">GTEx Brain Cerebellar Hemisphere eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Cerebellum.txt">GTEx Brain Cerebellum eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Cortex.txt">GTEx Brain Cortex eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Frontal_Cortex_BA9.txt">GTEx Brain Frontal Cortex BA9 eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Hippocampus.txt">GTEx Brain Hippocampus eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Hypothalamus.txt">GTEx Brain Hypothalamus eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Nucleus_accumbens_basal_ganglia.txt">GTEx Brain Nucleus accumbens basal ganglia eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Putamen_basal_ganglia.txt">GTEx Brain Putamen basal ganglia eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Spinal_cord_cervical_c-1.txt">GTEx Brain Spinal cord cervical c-1 eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Brain_Substantia_nigra.txt">GTEx Brain Substantia nigra eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Breast_Mammary_Tissue.txt">GTEx Breast Mammary Tissue eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Cells_Cultured_fibroblasts.txt">GTEx Cells Cultured fibroblasts eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Cells_EBV-transformed_lymphocytes.txt">GTEx Cells EBV-transformed lymphocytes eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Colon_Sigmoid.txt">GTEx Colon Sigmoid eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Colon_Transverse.txt">GTEx Colon Transverse eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Esophagus_Gastroesophageal_Junction.txt">GTEx Esophagus Gastroesophageal Junction eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Esophagus_Mucosa.txt">GTEx Esophagus Mucosa eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Esophagus_Muscularis.txt">GTEx Esophagus Muscularis eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Heart_Atrial_Appendage.txt">GTEx Heart Atrial Appendage eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Heart_Left_Ventricle.txt">GTEx Heart Left Ventricle eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Kidney_Cortex.txt">GTEx Kidney Cortex eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Liver.txt">GTEx Liver eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Lung.txt">GTEx Lung eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Minor_Salivary_Gland.txt">GTEx Minor Salivary Gland eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Muscle_Skeletal.txt">GTEx Muscle Skeletal eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Nerve_Tibial.txt">GTEx Nerve Tibial eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Ovary.txt">GTEx Ovary eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Pancreas.txt">GTEx Pancreas eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Pituitary.txt">GTEx Pituitary eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Prostate.txt">GTEx Prostate eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Skin_Not_Sun_Exposed_Suprapubic.txt">GTEx Skin Not Sun Exposed Suprapubic eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Skin_Sun_Exposed_Lower_leg.txt">GTEx Skin Sun Exposed Lower leg eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Small_Intestine_Terminal_Ileum.txt">GTEx Small Intestine Terminal Ileum eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Spleen.txt">GTEx Spleen eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Stomach.txt">GTEx Stomach eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Testis.txt">GTEx Testis eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Thyroid.txt">GTEx Thyroid eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Uterus.txt">GTEx Uterus eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Vagina.txt">GTEx Vagina eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_eQTL/Whole_Blood.txt">GTEx Whole Blood eQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Adipose_Subcutaneous.txt">GTEx Adipose Subcutaneous sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Adipose_Visceral_Omentum.txt">GTEx Adipose Visceral Omentum sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Adrenal_Gland.txt">GTEx Adrenal Gland sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Artery_Aorta.txt">GTEx Artery Aorta sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Artery_Coronary.txt">GTEx Artery Coronary sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Artery_Tibial.txt">GTEx Artery Tibial sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Amygdala.txt">GTEx Brain Amygdala sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Anterior_cingulate_cortex_BA24.txt">GTEx Brain Anterior cingulate cortex BA24 sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Caudate_basal_ganglia.txt">GTEx Brain Caudate basal ganglia sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Cerebellar_Hemisphere.txt">GTEx Brain Cerebellar Hemisphere sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Cerebellum.txt">GTEx Brain Cerebellum sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Cortex.txt">GTEx Brain Cortex sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Frontal_Cortex_BA9.txt">GTEx Brain Frontal Cortex BA9 sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Hippocampus.txt">GTEx Brain Hippocampus sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Hypothalamus.txt">GTEx Brain Hypothalamus sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Nucleus_accumbens_basal_ganglia.txt">GTEx Brain Nucleus accumbens basal ganglia sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Putamen_basal_ganglia.txt">GTEx Brain Putamen basal ganglia sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Spinal_cord_cervical_c-1.txt">GTEx Brain Spinal cord cervical c-1 sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Brain_Substantia_nigra.txt">GTEx Brain Substantia nigra sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Breast_Mammary_Tissue.txt">GTEx Breast Mammary Tissue sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Cells_Cultured_fibroblasts.txt">GTEx Cells Cultured fibroblasts sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Cells_EBV-transformed_lymphocytes.txt">GTEx Cells EBV-transformed lymphocytes sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Colon_Sigmoid.txt">GTEx Colon Sigmoid sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Colon_Transverse.txt">GTEx Colon Transverse sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Esophagus_Gastroesophageal_Junction.txt">GTEx Esophagus Gastroesophageal Junction sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Esophagus_Mucosa.txt">GTEx Esophagus Mucosa sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Esophagus_Muscularis.txt">GTEx Esophagus Muscularis sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Heart_Atrial_Appendage.txt">GTEx Heart Atrial Appendage sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Heart_Left_Ventricle.txt">GTEx Heart Left Ventricle sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Kidney_Cortex.txt">GTEx Kidney Cortex sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Liver.txt">GTEx Liver sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Lung.txt">GTEx Lung sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Minor_Salivary_Gland.txt">GTEx Minor Salivary Gland sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Muscle_Skeletal.txt">GTEx Muscle Skeletal sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Nerve_Tibial.txt">GTEx Nerve Tibial sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Ovary.txt">GTEx Ovary sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Pancreas.txt">GTEx Pancreas sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Pituitary.txt">GTEx Pituitary sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Prostate.txt">GTEx Prostate sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Skin_Not_Sun_Exposed_Suprapubic.txt">GTEx Skin Not Sun Exposed Suprapubic sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Skin_Sun_Exposed_Lower_leg.txt">GTEx Skin Sun Exposed Lower leg sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Small_Intestine_Terminal_Ileum.txt">GTEx Small Intestine Terminal Ileum sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Spleen.txt">GTEx Spleen sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Stomach.txt">GTEx Stomach sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Testis.txt">GTEx Testis sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Thyroid.txt">GTEx Thyroid sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Uterus.txt">GTEx Uterus sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Vagina.txt">GTEx Vagina sQTL</option>
                        <option value="Data/Pipeline/Resources/GTEx_v8_sQTL/Whole_Blood.txt">GTEx Whole Blood sQTL</option>
                      </optgroup>
        ...
        <td data-column="Upload/Select File &#xa;">
          ...
          <div id="Selectupload3" class="selectholder LDPrune" align="center">
            ...
            <select class="LDPrune" name="formChoice3" size="1" id="mdf_file">
              ...
              <option value="Data/Pipeline/Resources/LD_files/ld70.ceu.txt">CEU LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.ceu.txt">CEU LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld30.ceu.txt">CEU LD30</option>
              <option value="Data/Pipeline/Resources/LD_files/ld20.ceu.txt">CEU LD20</option>
              <option value="Data/Pipeline/Resources/LD_files/ld10.ceu.txt">CEU LD10</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.acb.txt">ACB LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.acb.txt">ACB LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.asw.txt">ASW LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.asw.txt">ASW LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.cdx.txt">CDX LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.cdx.txt">CDX LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.chb.txt">CHB LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.chb.txt">CHB LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.chs.txt">CHS LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.chs.txt">CHS LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.clm.txt">CLM LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.clm.txt">CLM LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.esn.txt">ESN LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.esn.txt">ESN LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.fin.txt">FIN LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.fin.txt">FIN LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.gbr.txt">GBR LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.gbr.txt">GBR LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.gih.txt">GIH LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.gih.txt">GIH LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.gwd.txt">GWD LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.gwd.txt">GWD LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.ibs.txt">IBS LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.ibs.txt">IBS LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.itu.txt">ITU LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.itu.txt">ITU LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.jpt.txt">JPT LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.jpt.txt">JPT LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.khv.txt">KHV LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.khv.txt">KHV LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.lwk.txt">LWK LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.lwk.txt">LWK LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.msl.txt">MSL LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.msl.txt">MSL LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.mxl.txt">MXL LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.mxl.txt">MXL LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.pel.txt">PEL LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.pel.txt">PEL LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.pjl.txt">PJL LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.pjl.txt">PJL LD50</option>
              <option value="Data/Pipeline/Resources/LD_files/ld70.pur.txt">PUR LD70</option>
              <option value="Data/Pipeline/Resources/LD_files/ld50.pur.txt">PUR LD50</option>

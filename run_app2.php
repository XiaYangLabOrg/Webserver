...
$sshpass_cmd_in_R="cat(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp -r \", drugNetworksDir,\" ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Resources/shinyapp2_temp/\", folder,\"/\n\"))" . "\n".
                  "system(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp -r \", drugNetworksDir,\" ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Resources/shinyapp2_temp/\", folder,\"/\"))" ."\n".
                  "cat(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID,\"_app2result.txt ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Results/shinyapp2/\",sessionID,\"_app2result.txt\"))"."\n".
                  "system(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID,\"_app2result.txt ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Results/shinyapp2/\",sessionID,\"_app2result.txt\"))" ."\n".
                  "cat(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID,\"_app2result_hepatotox.txt ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Results/shinyapp2/\",sessionID,\"_app2result_hepatotox.txt\"))"."\n".
                  "system(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID,\"_app2result_hepatotox.txt ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Results/shinyapp2/\",sessionID,\"_app2result_hepatotox.txt\"))" ."\n".
                  "cat(paste0(\"touch \", data_dir, sessionID, \"_is_done\"))"."\n".
                  "system(paste0(\"touch \", data_dir, sessionID, \"_is_done\"))"."\n".
                  "cat(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID, \"_is_done ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Resources/shinyapp2_temp/\",sessionID, \"_is_done\"))"."\n".
                  "system(paste0(\"~/bin/sshpass -p '".$env["MERGEOMICS_SERVER_PASSWORD"]."' scp \", data_dir, sessionID, \"_is_done ".$env["MERGEOMICS_SERVER_USERNAME"]."@".$env["MERGEOMICS_SERVER_IP"].":/home/smha118/mergeomics/html/Data/Pipeline/Resources/shinyapp2_temp/\",sessionID, \"_is_done\"))"."\n";

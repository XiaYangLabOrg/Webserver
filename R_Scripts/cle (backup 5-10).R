...
makeNewGeneSetFileOnlySNPMappedGenes <- function(geneset_file, details_file, return_only_mod_genes=TRUE){
 ...
 if(!return_only_mod_genes){
    write.table(result_all, "/home/smha118/mergeomics/html/Data/Pipeline/Results/ssea/New_GeneSets_SNP_mapped_all.txt", sep="\t", quote = FALSE, row.names = FALSE)
  }
  else{
    write.table(result, "/home/smha118/mergeomics/html/Data/Pipeline/Results/ssea/New_GeneSets_SNP_mapped.txt", sep="\t", quote = FALSE, row.names = FALSE)
  }
}
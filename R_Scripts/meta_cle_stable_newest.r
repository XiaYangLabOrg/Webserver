...
ssea.meta <- function(jobs, label, folder) {
  ...
  detail_file <- tool.read("/home/smha118/mergeomics/html/Data/Pipeline/Results/meta_ssea/4ipkMUlaKa_meta_result/ssea/4ipkMUlaKa_META.details.txt", c("MODULE","GENE"))
...
ssea.start.configure <- function(plan) {
  ...
  loci_file_name = paste("/home/smha118/mergeomics/html/Data/Pipeline/Resources/meta_temp/",plan$label,"_loci.txt",sep="")
  gene_file_name = paste("/home/smha118/mergeomics/html/Data/Pipeline/Resources/meta_temp/",plan$label,"_gene.txt",sep="")

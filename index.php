...
<!--<div style="text-align: center;padding: 20px 20px 0 20px;font-size: 16px;">
  <div class="alert alert-warning" style="margin: 0 auto; width: 50%;">
    ...
    <div style="text-align: center;padding-top: 2%;font-size: 20px;">The Mergeomics web tool is freely accessible to all users. Test2<br> We recommend using Chrome or Firefox for the best viewing experience.</div>
 ...
 <!-- Footer ends
  ...
  // unmask this for maintenance notification

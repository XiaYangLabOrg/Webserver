...
<ul class="list-unstyled components nav1">
  ...
  <p style="padding-top:0px;">
  	ToxiOmics is being actively developed by the Yang Lab in the Department of Integrative Biology and Physiology at UCLA. 
  </p>
...
<div class="margin_rm" style="margin-bottom: 200px;">
	<div class="container clearfix" id="myContainer" style="margin-bottom: 40px;">
		...
		<div style="margin-top: 4%;font-size: 20px;margin: 3% 5% 0%;">
				ToxiOmics is a comprehensive drug knowledgebase and analytical tool comprised of genomic footprints of drugs in individual tissues from multiple species (human, mouse, and rat) based on global transcriptome data from public repositories (GEO, ArrayExpress, TG-GATEs, drugMatrix). The ToxiOmics web server features three functions: i) species- and tissue-stratified drug DEGs and pathway signatures query, ii) network-based drug repositioning, and iii) overlap-based drug repositioning.
		</div>
		...
		<div class="toggle toggle-border" style="width: 98%;" id="App2">
	        ...
	        <div class="togglec" id="app2tut">
	        	...
	        	<p style="font-size: 20px;margin: 1% 1% 1% 1%;padding: 0px;text-align: left;">
	        	5. <b>(Optional) Submit email for results to be sent to you.</b> Enter email in the text field and click 'Send email' to receive results to your email. If you do not receive results, the email may have been sent to spam. Alternatively, enter your session ID in the ToxiOmics home session ID prompt, and the results should load if finished.
	        	</p>
	        	<p style="font-size: 20px;margin: 1% 1% 1% 1%;padding: 0px;text-align: left;">
